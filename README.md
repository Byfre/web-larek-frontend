...
Интернет-магазин для веб-разработчиков.

🚀 Демо 
https://test-brown-eight-35.vercel.app/
...
Проект реализован с использованием MVP (Model-View-Presenter) в связке с событийно-ориентированным подходом.

    Слой данных — хранение и изменение состояния приложения (AppState, ProductData)

    Слой представления — отображение UI-компонентов (Page, Modal, Card, Basket, Form)

    Презентер — связь данных и представления через события (EventEmitter)

🎯 Функциональность

    Просмотр каталога товаров

    Открытие карточки товара с детальной информацией в модальном окне

    Добавление/удаление товаров в корзину

    Оформление заказа в два этапа:

        Выбор способа оплаты + адрес доставки
    ...
    Сообщение об успешной оплате с автоматической очисткой корзины
